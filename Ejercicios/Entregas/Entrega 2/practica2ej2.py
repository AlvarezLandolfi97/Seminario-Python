...
"""
lista = repo.strip().split(' ')
# print(lista)
palabra_mas_frecuenta_y_cant = Counter(lista).most_common(1)
print(palabra_mas_frecuenta_y_cant)
palabra_mas_frecuenta = palabra_mas_frecuenta_y_cant[0][0]
print(palabra_mas_frecuenta)
# for i in lista:
#    print(i)
